...
public class FastLocationSwitcher {
    ...
    public FastLocationSwitcher(final XC_LoadPackage.LoadPackageParam lpparam) {
        try {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        try {
                                            ...
                                            if ((Double) m.invoke(receiver) != 0 && (Double) m2.invoke(receiver) != 0) {
                                                ...
                                                Utils.updateFeedAndLocation(Options.INSTANCE.getLocation().getLat(), Options.INSTANCE.getLocation().getLng());
                                            } else {
                                                dialog.dismiss();
                                                TSnackbar.make(lpparam, "Please set a location first!");
                                            }

                                        } catch (Exception e) {
                                            TSnackbar.make(lpparam, "Something went wrong: " + e.getLocalizedMessage());
                                            e.printStackTrace();
                                        }
                                    }
                                });
            ...
            e.printStackTrace();
            Log.dlog("!!!!!!!!!! Failed loading FastLocationSwitcher hook !!!!!!!!!!");
        }
    }
}
